    ...
    private func detectDomains(in text: String) -> [String] {
        let domainKeywords: [String: [(keyword: String, weight: Int)]] = [
            "Teknik": [("kod", 2), ("programmering", 3), ("algoritm", 3), ("dator", 2), ("app", 2), ("software", 3),
                       ...
                       ("kryptering", 3), ("molntjänst", 2), ("devops", 3), ("container", 2), ("microservice", 3),
                       ("frontend", 2), ("backend", 2), ("fullstack", 3), ("version", 1), ("deploy", 2),
                       ("kompilera", 2), ("debug", 2), ("refaktorera", 2), ("arkitektur", 2), ("protokoll", 2)],
            "Vetenskap": [("forskning", 3), ("studie", 2), ("experiment", 3), ("teori", 2), ("hypotes", 3),
                         ("biologi", 3), ("fysik", 3), ("kemi", 3), ("molekyl", 2), ("evolution", 3), ("gen", 2),
                         ("cell", 2), ("atom", 2), ("kvant", 3), ("relativitet", 3), ("dna", 3),
                         ("ekosystem", 2), ("klimat", 2), ("astronomi", 3), ("geologi", 3), ("neurovetenskap", 3),
                         ("partikel", 2), ("energi", 1), ("entropi", 3)],
            "Historia": [("historia", 3), ("historisk", 2), ("forntid", 2), ("krig", 2), ("revolution", 2),
                        ("antiken", 3), ("medeltid", 3), ("civilisation", 2), ("monarki", 2), ("arkeologi", 3),
                        ("renässans", 3), ("upplysning", 3), ("koloni", 2), ("imperium", 2), ("reform", 2),
                        ("vikingatid", 3), ("stormaktstid", 3), ("demokrati", 2), ("diktatur", 2), ("migration", 2)],
            "Psykologi": [("psykologi", 3), ("beteende", 2), ("emotion", 2), ("känsla", 2), ("ångest", 2),
                         ("depression", 2), ("terapi", 2), ("kognitiv", 2), ("personlighet", 2), ("trauma", 2),
                         ("motivation", 2), ("stress", 2), ("anknytning", 3), ("medvetenhet", 2), ("dröm", 2),
                         ("självkänsla", 2), ("empati", 2), ("resiliens", 3), ("narcissism", 3), ("introvert", 2)],
            "Ekonomi": [("ekonomi", 3), ("pengar", 2), ("investering", 3), ("aktier", 2), ("marknad", 2),
                       ("inflation", 2), ("budget", 2), ("finans", 3), ("skatt", 2), ("handel", 2),
                       ("bnp", 3), ("ränta", 2), ("börs", 2), ("kryptovaluta", 3), ("tillgång", 2),
                       ("avkastning", 3), ("recession", 3), ("konjunktur", 3), ("entreprenör", 2), ("startup", 2)],
            "Kultur": [("kultur", 3), ("konst", 2), ("musik", 2), ("film", 2), ("litteratur", 3),
                      ("teater", 2), ("design", 2), ("arkitektur", 2), ("museum", 2), ("poesi", 2),
                      ("dans", 2), ("fotografi", 2), ("skulptur", 2), ("opera", 2), ("folklore", 3),
                      ("mode", 2), ("gastronomi", 3), ("hantverk", 2), ("kalligrafi", 3), ("grafitti", 2)],
            "Språk": [("språk", 2), ("grammatik", 3), ("ord", 1), ("svenska", 2), ("engelska", 2),
                     ("lingvistik", 3), ("etymologi", 3), ("dialekt", 2), ("uttal", 2), ("ordförråd", 2),
                     ("morfologi", 3), ("syntax", 3), ("semantik", 3), ("pragmatik", 3), ("fonologi", 3),
                     ("tvåspråkighet", 3), ("sociolekt", 3), ("kreol", 3), ("pidgin", 3), ("teckenlöst", 2)],
            "Filosofi": [("filosofi", 3), ("etik", 2), ("moral", 2), ("existens", 2), ("medvetande", 2),
                        ("fri vilja", 3), ("ontologi", 3), ("epistemologi", 3), ("logik", 2),
                        ("fenomenologi", 3), ("utilitarism", 3), ("determinism", 3), ("nihilism", 3),
                        ("stoicism", 3), ("empirism", 3), ("rationalism", 3), ("pragmatism", 3), ("hermeneutik", 3)],
            "Matematik": [("matematik", 3), ("ekvation", 3), ("algebra", 3), ("geometri", 3), ("statistik", 3),
                         ("kalkyl", 2), ("bevis", 2), ("tal", 1), ("formel", 2),
                         ("topologi", 3), ("sannolikhet", 3), ("integral", 3), ("derivata", 3), ("matris", 3),
                         ("primtal", 3), ("kombinatorik", 3), ("grafteori", 3), ("logik", 2), ("mängdlära", 3)],
        ]
